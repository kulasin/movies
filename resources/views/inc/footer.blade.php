@yield('content')
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="https://basawe.com/cv">Nedim Kulašin</a>.</strong> All rights reserved.
  </footer>
...
<script>
  $(function () {
    $("#example1").DataTable({
      order: [[0, 'desc']], "paging": false, "responsive": true, "lengthChange": false, "autoWidth": false,
